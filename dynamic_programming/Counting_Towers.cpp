 ...
 * Solution for: https://cses.fi/problemset/task/2413/
*/
...
// Do not need to think about the horizontal line in each row but only care about VERTICAL line
// dp[i][0] => number of way build tower with height i and ith row has two    vertical lines: |         |
    // |         |      |         |         |         |     -- i-th row
    //                  -----------         -----------     -- i-1th row
    // |         |      |         |         |    |    |

// dp[i][1] => number of way build tower with height i and ith row has three  vertical lines: |    |    |
    // |    |    |      |    |    |         |    |    |         |    |    |     -- i-th row
    // -----------      ------                   ------         -----------     -- i-1th row
    // |         |      |    |    |         |    |    |         |    |    |
const int mxn = 1e6 + 5;
